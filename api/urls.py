...
from .views import TwitteList, EditTwitte, PostTwitte, LoginOut, UserProfileUpdate, get_user, FollowToggle
app_name = 'api'
urlpatterns = [
    ...
    path("account/followToggle/<str:username>", FollowToggle.as_view(), name='follow'),
